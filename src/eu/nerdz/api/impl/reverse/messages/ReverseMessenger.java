...
public class ReverseMessenger extends AbstractReverseApplication implements Messenger {
    ...
    private ConversationHandler createHandler() {
        ...
        return new ReverseConversationHandler();
    }
    ...
    private class ReverseConversationHandler implements ConversationHandler {
        ...
        public List<Message> getMessages(Conversation conversation, int start, int howMany) throws IOException, HttpException, ContentException {
            ...
            return this.getMessagesAndCheck(conversation, start, howMany).getKey();

        }

        Pair<List<Message>, Boolean> getMessagesAndCheck(Conversation conversation, int start, int howMany) throws IOException, HttpException, ContentException {
